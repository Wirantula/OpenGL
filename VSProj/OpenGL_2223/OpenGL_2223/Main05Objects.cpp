...
int main()
{
	...
	heightNormalID = loadTexture("textures/NormalMap.png");
	...
	arm = new Model("Models/arm/arm.obj");
	head = new Model("Models/head/head.obj");
	skull = new Model("Models/skull/skull.obj");
	alien = new Model("Models/alien/alien.obj");
